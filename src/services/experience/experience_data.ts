import { ExperienceData } from "../../utils/dataTypes";

export const experience_data: ExperienceData = {
  cards: {
    experience_data__0: {
      id: "experience_data__0",
      name: "clickPaint",
      date: "November 2024",
    ...
    experience_data__3: {
      id: "experience_data__3",
      name: "my_simple_calculator",
      date: "September 2024",
      technologies: ["React", "Math.js"],
    },

    experience_data__4: {
      id: "experience_data__4",
      name: "rotjournal",
      date: "March 2024",
      technologies: [
        "React",
    ...
    experience_data__5: {
      id: "experience_data__5",
      name: "norskapp",
      date: "Februray 2024",
      technologies: ["React", "Styled Compoenents", "React Router DOM"],
    },

    experience_data__6: {
      id: "experience_data__6",
      name: "matrices_operations_class",
      date: "July 2024",
  ...
  screens: {
    experience_data__0: {
      ...
      technologies: ["React", "Tailwind", "Redux"],
      images: [
        "./large_screen__click_paint--login_form.jpg",
        "./large_screen__click_paint--map.jpg",
        "./small_screen__click_paint--login_form.jpg",
        "./small_screen__click_paint--map.jpg",
      ],
      summary:
    ...
    experience_data__1: {
      ...
      technologies: ["React", "Styled Components"],
      images: [
        "./large_screen__safe_gossip--login_form.jpg",
        "./large_screen__safe_gossip--gossip_entry_form.jpg",
        "./large_screen__safe_gossip--summary.jpg",
        "./small_screen__safe_gossip--gossip_entry_form.jpg",
    ...
    experience_data__2: {
      ...
      date: "April 2024",
      technologies: ["Vue,", "Pinia", "Tailwind", "Supabase", "Vue Router"],
      images: [], //Carmic images will be loaded after the server is active again.
      summary:
    ...
    experience_data__3: {
      ...
      date: "September 2024",
      technologies: ["React", "Math.js"],
      images: ["all_screens__my_simple_calculator--calculator.jpg"],
      summary:
    ...
    experience_data__4: {
      ...
      images: [
        "./all_screens__dark__rotjournal--login_form.jpg",
        "./all_screens__dark__rotjournal--preview.jpg",
        "./all_screens__light__rotjournal--login_form.jpg",
        "./all_screens__light__rotjournal--preview.jpg",
        "./all_screens__light__rotjournal--decrypted.jpg",
      ],
      summary:
    ...
    experience_data__5: {
      ...
      technologies: ["React", "Styled Compoenents", "React Router DOM"],
      images: [
        "./all_screens__norskapp.jpg",
        "./small_screens__norskapp.jpg",
        "./large_screens__norskapp.jpg",
      ],
      summary:
